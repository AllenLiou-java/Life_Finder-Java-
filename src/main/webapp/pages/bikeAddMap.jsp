...
<body>
    ...
    <div class="headpho">
        <img src="${pageContext.request.contextPath}/pic/Youbike_top.jpg" alt="">
    </div>

    <nav  class="navbar navbar-expand-lg bg-dark navbar-dark justify-content-center sticky-top">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/homepg.jsp"><img src="${pageContext.request.contextPath}/pic/Logo.png" alt=""  style="height: 35px;"></a>
        <span>&emsp;</span>
        <ul class="navbar-nav">
    ...
    <div class="contentArea">
        <h2 id="mapTitle">UBike 站點資訊即時訊息</h2>
        ...
        <div class="StopStatus">
            <ul>
                ...
                <li><img src="${pageContext.request.contextPath}/pic/marker-icon-2x-orange.png" alt="" width="20px">
                    <span>無車可借</span>
                </li>
	...
	<div class="pgBar">
		...
		<c:if test="${pageNos>1 }">
			<a href="/final-webproj/pages/bike.controller?pageNos=1#pgHead"> « 首頁 </a>
			<a href="/final-webproj/pages/bike.controller?pageNos=${pageNos-1 }#pgHead">上一頁</a>
		</c:if>
		
		<c:if test="${pageNos <recordCount }">
			<a href="/final-webproj/pages/bike.controller?pageNos=${pageNos+1 }#pgHead">下一頁</a>
			<a href="/final-webproj/pages/bike.controller?pageNos=${recordCount }#pgHead">末頁 » </a>
		</c:if>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/bike.js"></script>
